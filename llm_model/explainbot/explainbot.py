    ...
    def chat_recommendation_explanation(self, input_data):
        ...
        try:
            ...
            content_begin = (
                ...
                "\n"
                "- **Recommendation Explanation:** *The Priory of the Orange Tree* was recommended based on what similar users to you selected. While it doesn’t directly match your specific preferences for fast-paced, action-heavy fantasy, readers who enjoyed *Mistborn* and *Harry Potter* often appreciated its deep world-building and intricate political plotlines. This recommendation aims to offer a book with rich narrative complexity that might expand your reading horizons and challenge your typical reading style, similar to how other users with similar tastes have enjoyed it despite some differences in genre focus.\n"
                "\n---\n"
                "### Example 5\n"
                "**User Data:**\n"
